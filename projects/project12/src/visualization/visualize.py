...
test_img, tensor_labels, img_path0, BB = list(iter(val_data))[61] #41=cans in fence, 61=can with leaves, 
...
all_selected_boxes, all_selected_probs, all_selected_preds = NMS(BB_all_predicted, bb_class, bb_confidence, classes[:-1], iout = 0.5, st = 0.3, max_out = 10)
